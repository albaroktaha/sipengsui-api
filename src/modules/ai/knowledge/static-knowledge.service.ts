...
export class StaticKnowledgeService implements KnowledgeRetriever {
  private readonly chunks: KnowledgeChunk[] = [
    ...
    },
    {
      ...
      content:
        'Permohonan Rekomtek adalah perkara pengajuan milik Pemohon yang memiliki tahap, penugasan, Berkas Persyaratan, Artefak Proses, dan riwayat keputusan sendiri. Alur resminya: Pemohon mengajukan setelah seluruh Berkas Persyaratan wajib valid → Pejabat Rekomtek menunjuk koordinator dan anggota Pokja Rekomtek → Pokja menjalankan Evaluasi Dokumen Awal. Pokja hanya boleh memberi satu Kesempatan Perbaikan Awal dengan temuan per berkas. Jika Evaluasi Dokumen Ulang tetap tidak memenuhi, sistem mewajibkan Surat Penolakan dan perkara menjadi terminal Ditolak. Jika memenuhi, proses berjalan ke Ekspose terjadwal dan Berita Acara Ekspose. Setelah itu Pejabat Rekomtek memutuskan apakah ada revisi dokumen: bila ada, Pemohon masuk Perbaikan Pasca-Ekspose dan mengunggah dokumen yang direvisi; bila tidak ada, proses lanjut ke SPT Lapangan. Tahap berikutnya adalah Kunjungan Lapangan, Berita Acara Lapangan, Sidang Rekomtek, Berita Acara Sidang, penyusunan Surat Persetujuan dan Draft Rekomtek, Pemeriksaan Pejabat, Persetujuan Atasan Pejabat, lalu Dokumen Rekomtek final terbit. Status umum Draft/Review/Approved/Rejected/Published adalah proyeksi kompatibilitas; tahap rinci dan audit event menjadi sumber kebenaran workflow.',
      accessLevel: 'public',
    },
    {
